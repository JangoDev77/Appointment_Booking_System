...
const Header = () => {
    return (
        <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6  md:px-10 lg:px-20px'>
            <div className='md:1/2 :1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
                ...
                <div className='flex flex-col md:flex-row gap-3 text-white text-sm  font-light'>
                    ...
                    <p >Simple Browse through our extensive list of doctors,<br className='hidden sm:block'/>schedule your appointment hassle-free</p>
