...
const RelatedDoctors = ({speciality,docId}) => {
    ...
    useEffect(() => {
        if (doctors?.length > 0 && speciality) {  // Use optional chaining
            const doctorsdata = doctors.filter((doc) => doc?.speciality === speciality && doc?._id !== docId); // Use optional chaining
