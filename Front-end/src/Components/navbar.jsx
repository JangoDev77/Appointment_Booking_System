    ...
    return (
        <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
            ...
            <div className='flex items-center gap-4'>
                 ...
                 <div className='flex items-center gap-2 cursor-pointer group relative'>
                    ...
                    <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 hidden group-hover:block'> 
                        <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                            ...
                            <p onClick={()=>setTokens(false)} className='hover:text-black cursor-pointer'>Log Out</p>
                        </div>
                    </div>
                 </div>
                 :
             ...
             {/* Mobile Menu */}
              <div className={`${showMenu? 'fixed w-full':'h-0w w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                <div className='flex items-center justify-between px-5 py-7'>
                    <img className='w-36' src={assets.logo} alt="" />
                    <img onClick={()=>SetMenu(false)}  className='w-7'src={assets.cross_icon} alt="" />
                </div>
